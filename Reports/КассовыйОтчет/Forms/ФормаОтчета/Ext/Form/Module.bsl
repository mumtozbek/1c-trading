...
Процедура ТабДокОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка, ДополнительныеПараметры)
	Если ТипЗнч(Расшифровка) = Тип("Структура") Тогда
		...
		ЗначенияЗаполнения = Новый Структура("Период,Касса,Статья,Подробно", Отчет.Период, Отчет.Касса, Отчет.Статья, Истина);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		Отчет.Касса = ХранилищеНастроекДанныхФорм.Загрузить("Отчет." + ЭтотОбъект.ИмяФормы, "Касса");
		Отчет.Статья = ХранилищеНастроекДанныхФорм.Загрузить("Статья." + ЭтотОбъект.ИмяФормы, "Статья");
...
Процедура ПередЗакрытиемНаСервере()
	...
	ХранилищеНастроекДанныхФорм.Сохранить("Отчет." + ЭтотОбъект.ИмяФормы, "Касса", Отчет.Касса);
