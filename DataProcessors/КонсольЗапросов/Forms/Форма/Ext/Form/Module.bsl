...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Объект.Заголовок = "Консоль запросов v" + Объект.ВерсияОбработки;
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если ЗавершениеРаботы = Истина Тогда
		...
		Если Модифицированность Тогда
			...
			ТекстПредупреждения = "В консоли запросов имеется не сохраненный пакет запросов! ";
			Отказ = Истина;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ТекстПредупреждения) Тогда
			...
			ТекстПредупреждения = "Для сохранения состояний консоль запросов рекомендуется закрывать вручную.";
			Отказ = Истина;
		КонецЕсли;
